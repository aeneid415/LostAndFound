      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Item Loss</h3>
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Please fill in the needed details</h4>
                      <form action="<?php echo base_url();?>Admin/submitLoss" role="form" method="post" accept-charset="utf-8" class="form-horizontal style-form">
                      <div class="row">

                        <div class="col-lg-4 col-md-4 col-sm-4" style="padding-bottom: 15px;">
                              <label for="type">Date Reported to Student Affairs</label>
                              <input  class="form-control" name="date_reported" type="date" id="example-number-input" required>

                        </div>

                        <div class="col-lg-4 col-md-4 col-sm-4" style="padding-bottom: 15px;">
                              <label for="type">Reported by/Owner of LFI</label>
                              <input class="form-control" name="ownerLFI" type="text"  placeholder="e.g: Juan Dela Cruz" id="example-number-input" required>

                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4" style="padding-bottom: 15px;">
                              <label for="type">Cellphone Number</label>
                              <input class="form-control" name="phone_number" type="text"  placeholder="e.g: 09987876777" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4" style="padding-bottom: 15px;">
                              ...
                              <input  class="form-control" name="course_year" type="text" placeholder="e.g: BSIT-2" required>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4" style="padding-bottom: 15px;">
                            ...
                            <div class="form-check form-check-inline">
                              ...
                              <input class="form-check-input"  type="radio" name="reported" id="owner1" value="Owner">
                              <label class="form-check-label" for="owner1">Owner</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <!-- <input  class="form-control" name="item_owner" type="text" placeholder="e.g: Anita Turner"> -->
                              <input class="form-check-input"  type="radio" name="reported" id="owner2" value="Informant">
                              <label class="form-check-label" for="owner2">Informant (but not the owner)</label>
                            </div>

                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4" style="padding-bottom: 15px;">
                              <label for="type">OSA Personnel Attending</label>
                              <input  class="form-control" name="osa_personnel" type="text" placeholder="e.g: Gracielle Yano" required>
                        </div>
                        <!--
                          <div class="form-group">
                      ...
                      <hr>
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Circumstances of Loss</h4>
                      <div class="row">

                          <div class="col-lg-6 col-md-6 col-sm-6" style="padding-bottom: 15px;">
                              <label for="type">WHEN Lost/Left:</label>
                              <textarea class="form-control" rows="5" name="lost_time"></textarea>
                          </div>
                                  
                          <div class="col-lg-6 col-md-6 col-sm-6" style="padding-bottom: 15px;">    
                            <label for="type">WHERE Lost/Left:</label>
                            <textarea class="form-control" rows="5" name="lost_location"></textarea>
