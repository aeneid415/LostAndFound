                          ...
                          <table id="found" class="table table-striped table-advance table-hover"  >
                            ...
                            <?php } ?>
                              ...
                              <tr>
                                  ...
                                  <th>Reported by</th>
                                  <th>Course & Year/Dept.</th>
                                  <th>SAO Personnel Attending</th>
                                  <th>Date Reported</th>
                                  <th>Date Issued</th>
                                  <th>Action</th>
                              </tr>
                              ...
                              <tbody>
                              <?php
                                if($fetch_lostItems->num_rows() > 0){

                                  foreach ($fetch_lostItems -> result() as $row) 
                                  {
                                ?>
                              <tr>
                                  <td><?php echo $row->record_id; ?></td>
                                  <td><?php echo $row->reported_name; ?></td>
                                  <td><?php echo $row->cellphone_number; ?></td>
                                  <td><?php echo $row->type; ?></td>
                                  <td><?php echo $row->course_year_dept; ?></td>
                                  <td><?php echo $row->attending_personnel; ?></td>
                              ...
                              ?>
                              <tr>
                                <td colspan = 9 style = "text-align: center;"> <h3>No items found</h3> </td>
                              </tr>
                              <?php
                                }
